> This project was derived from a [template on html.design](https://html.design/download/recipelist-food-template/), which is distributed under a Creative Commons 3.0 license, [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/). The `inaccessible-recipes-list` repository is hosted with the same license.
